...
import tehmipssemyoulatur.RegisterFile;
...
public class Decode extends PipelineStage {
	...
	private static final int RD_MASK = 0xF800; // 1111 1000 
	...
	private static final int IMMEDIATE_MASK = 0xFFFF; //1111 1111 1111 1111
	private static final int IMMEDIATE_SHIFT = 0;
	private static final int ADDRESS_MASK = 0x3FFFFFF; //11 1111 1111 1111 1111 1111 1111
	...
	private HashMap<RegisterName, Long> setControlLines(long opCode, long funct) {
		...
		switch ((int)opCode) {
			case ARITH_OP_CODE:
				...
				switch ((int)funct) {
                                    //yo3'yar el code beta3 el add man3an lel e7rag
                                        case ADD_FUNCT:
						values.put(RegisterName.ALU_OP, 10l);
						id_ex.setValue(RegisterName.ALU_OP, 10l);
						break;
					case SUB_FUNCT:
